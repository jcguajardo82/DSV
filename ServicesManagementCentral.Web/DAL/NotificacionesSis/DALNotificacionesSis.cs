...
namespace ServicesManagement.Web.DAL.NotificacionesSis
{
    public class DALNotificacionesSis
    {
        ...
        public static DataSet ImagenNotificacion_Del(int IdImagen, string ModifUser)
        {
            ...
            try
            {
                ...
                ds = Soriana.FWK.FmkTools.SqlHelper.ExecuteDataSet(CommandType.StoredProcedure, "[dbo].[ImagenNotificacion_Del]", false, parametros);
