...
namespace ServicesManagement.Web.DAL.Almacenes
{
    public class DALAlmacenes
    {
        ...
        public static DataSet SuppliersContacts_sUP(int idSupplierWH, int idSupplierWHCode)
        {
            ...
            try
            {
                ...
                ds = Soriana.FWK.FmkTools.SqlHelper.ExecuteDataSet(CommandType.StoredProcedure, "[common].[SuppliersContacts_sUP]", false, parametros);
